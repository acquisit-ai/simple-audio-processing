...
INSTRUCTIONS = (
    ...
    "S) Be bold but judicious: prefer fewer, clearer clusters over many fine distinctions that confuse learners.\n"
    ...
    "- english_label: Short English explanatory rephrases, near Synonyms, aligned with chinese_label.\n"
